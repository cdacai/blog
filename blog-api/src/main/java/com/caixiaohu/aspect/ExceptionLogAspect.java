...
import com.caixiaohu.service.ExceptionLogService;
import com.caixiaohu.util.AopUtils;
...
public class ExceptionLogAspect {
	 ...
	 * 配置切入点
	 */
	@Pointcut("execution(* com.caixiaohu.controller..*.*(..))")
