...
public class CategoryAdminController {
	 ...
	 * @return
	 */
	@OperationLogger("设置默认分类")
	@PutMapping("/category/{id}/default")
	public Result setDefaultCategory(@PathVariable Long id) {
		categoryService.setDefaultCategory(id);
		return Result.ok("默认分类设置成功");
	}
}
