package com.caixiaohu.util.quartz;
...
import com.caixiaohu.service.ScheduleJobService;
import com.caixiaohu.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.caixiaohu.entity.ScheduleJob scheduleJob = (com.caixiaohu.entity.ScheduleJob) context.getMergedJobDataMap().get(com.caixiaohu.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
