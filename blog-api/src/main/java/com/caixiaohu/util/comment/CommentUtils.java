package com.caixiaohu.util.comment;
...
import com.caixiaohu.constant.PageConstants;
import com.caixiaohu.constant.RedisKeyConstants;
import com.caixiaohu.entity.User;
import com.caixiaohu.enums.CommentOpenStateEnum;
...
import com.caixiaohu.service.FriendService;
...
import com.caixiaohu.util.QQInfoUtils;
import com.caixiaohu.util.StringUtils;
import com.caixiaohu.util.comment.channel.ChannelFactory;
import com.caixiaohu.util.comment.channel.CommentNotifyChannel;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(com.caixiaohu.entity.Comment comment, boolean isVisitorComment, com.caixiaohu.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.caixiaohu.entity.Comment parentComment, com.caixiaohu.entity.Comment comment) {
	 ...
	 * @param comment 当前收到的评论
	 */
	private void notifyMyself(com.caixiaohu.entity.Comment comment) {
	 ...
	 */
	public static CommentPageEnum getCommentPageEnum(com.caixiaohu.entity.Comment comment) {
	 ...
	 * @param comment 当前收到的评论
	 */
	private void setCommentRandomAvatar(com.caixiaohu.entity.Comment comment) {
		//设置随机头像
	 ...
	 * @param admin   博主信息
	 */
	private void setGeneralAdminComment(com.caixiaohu.entity.Comment comment, User admin) {
	 ...
	 * @param comment 评论DTO
	 */
	public void setAdminCommentByTelegramAction(com.caixiaohu.entity.Comment comment) {
	 ...
	 * @param admin   博主信息
	 */
	public void setAdminComment(com.caixiaohu.entity.Comment comment, HttpServletRequest request, User admin) {
		setGeneralAdminComment(comment, admin);
	 ...
	 * @param request 用于获取ip
	 */
	public void setVisitorComment(com.caixiaohu.entity.Comment comment, HttpServletRequest request) {
	 ...
	 */
	private void setCommentQQAvatar(com.caixiaohu.entity.Comment comment, String qq) throws Exception {
